...
for model in lmodel:
  odir_root  = "/media/disk2/data/JRA55/sa.one.%s/my.mean"%(model)
  odir       = odir_root + "/%s"%(var)
  mk_dir(odir)

  tempdir_root  = "/media/disk2/data/JRA55/temp.bn"
  #******************************************
  #--- LAT & LON & NX, NY : upscaled  -------
  cmiplist_dir = "/mnt/iis.data1/utsumi/CMIP5"
